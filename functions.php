	...
	function formDier($arrDier,$idCurrentDier){
        ...
        if($idCurrentDier != NULL){
            ...
            <div class='row'>
                ...
                <div class='col-12'>
                    <h2>Eigenaars</h2>kehba
                </div>
                <div class='col-6'>
                    <div class='form-group'>";
                    foreach ($arrDier[$idCurrentDier]['eigenaars'] as $idEigenaar => $dataEigenaar) {
                        $returnString .= "<label for='naamEigenaar'>Naam</label>
                        <input type='text' class='form-control' id='eigenaar$idEigenaar' name='eigenaar$idEigenaar' value='{$dataEigenaar['naamEigenaar']}'>";
                    };
                $returnString .= "</div>
                </div>
                <div class='col-12'>
                ...
                <div class='col-6'>
                    ...
                    foreach ($arrDier[$idCurrentDier]['aandoeningen'] as $idAandoening => $dataAandoening) {
                        ...
                        <input type='text' class='form-control' id='aandoening$idAandoening' name='aandoening$idAandoening' value='{$dataAandoening['aandoening']}'>
                        <label for='beschrijvingAandoening'>Beschrijving</label>
                        <input type='text' class='form-control' id='beschrijving$idAandoening' name='beschrijving$idAandoening' value='{$dataAandoening['beschrijvingAandoening']}'>";
                    };
                    $returnString .= "</div>
                </div>
                <div class='col-12'>
                ...
                <div class='col-10'>
                    ...
                    foreach ($arrDier[$idCurrentDier]['behandelingen'] as $idBehandeling => $dataBehandeling) {
                        ...
                        <input type='text' class='form-control' id='datum$idBehandeling' name='datum$idBehandeling' value='{$dataBehandeling['datumBehandeling']}'>
                        <label for='behandeling'>Behandeling</label>
                        <input type='text' class='form-control' id='behandeling$idBehandeling' name='behandeling$idBehandeling' value='{$dataBehandeling['behandeling']}'>";
                    };
                    $returnString .= "</div>
                </div>
            </div><hr>";
            ...
            <div class='col-12'>
                ...
                <div class='col-6'>
                    ...
                    foreach ($arrDier[$idCurrentDier]['aandoeningen'] as $idAandoening => $dataAandoening) {
                        $returnString .= "<label for='aandoening'>Aandoening</label>
                        <input type='text' class='form-control' id='aandoening$idAandoening' name='aandoening$idAandoening' value=''>
                        <label for='beschrijvingAandoening'>Beschrijving</label>
                        <input type='text' class='form-control' id='beschrijving$idAandoening' name='beschrijving$idAandoening' value=''>";
                    };
                    $returnString .= "</div>
                </div>
            <div class='col-12'>
                ...
                <div class='col-10'>
                    ...
                    foreach ($arrDier[$idCurrentDier]['behandelingen'] as $idBehandeling => $dataBehandeling) {
                        $returnString .= "<label for='datumBehandeling'>Datum</label>
                        <input type='text' class='form-control' id='datum$idBehandeling' name='datum$idBehandeling' value=''>
                        <label for='behandeling'>Behandeling</label>
